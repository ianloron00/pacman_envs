...
from pacman import *
from game import *
from iUpdate import PacmanState as Update
from iFeatures import *
...
class PacmanEnv(gym.Env):
    ...
    def step(self, action):
        ...
        # update features
        self.frame = Update.get_frame(self, self.game.state, action)

        # update state
        self.state = Update.get_state(self)
        
        # update reward
        Update.update_reward(self, self.game.state.data.score, action)
    ...
    def initialize_observation_space(self):
        Update.initialize_observation_space(self)
